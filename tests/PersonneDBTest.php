...
*/ 
    public function testSelectionNom() {
        ...
        $a = new Adresse(99,32, "Victore Hugauh", 44000, "Nantes",4);
        $p=new Personne("Valjean", "jean",$dt,"0712233445","jvaljean@free.fr","jvaljean","cosette",$a);
        $p->setPwd("cosette");
        $this->personne->ajout($p);
...
*/
    ...
    $tab["adresse"]= new Adresse(99,32, "Victore Hugauh", 44000, "Nantes",4);
...
*/
    public function testUpdate() {
        ...
        $p=new Personne("Martin", "Eric",$dt,"0102030405","meric@orange.fr","meric","4755edd32703675c6a021322f9ca0433",$a);
        //update pers 
    ...
    public function testAuthentification(){
        ...
        $this->assertTrue($this->personne->authentification('terieur','vdm'));
    }
